...
${OBJECTDIR}/_ext/6e2d5a1d/XMLTools.o: ../massiva/XMLParsingTools/XMLTools.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -Wall -I/C/msys/1.0/mingw32/include/libxml2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/6e2d5a1d/XMLTools.o ../massiva/XMLParsingTools/XMLTools.c

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DLIBXML_STATIC -I/C/msys/1.0/mingw32/include/libxml2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/test_campaign_parser.o: test_campaign_parser.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -DLIBXML_STATIC -I/C/msys/1.0/mingw32/include/libxml2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_campaign_parser.o test_campaign_parser.cpp
